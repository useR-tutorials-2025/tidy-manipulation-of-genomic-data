...
-   Using `tidyomics` for *XYZ* Dataset
    ...
    -   include links to zulip channels/githubs for development of new types such as `tidySpacialExperiment` and `tidySCE`. <!-- unsure about tidySpacialExperiment - maybe I should do some research first -->
